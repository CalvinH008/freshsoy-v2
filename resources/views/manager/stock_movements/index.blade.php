...
@section('content')
    ...
    <form action="{{ route('inventory.stock-movements.index') }}" method="GET"
        ...
        <a href="{{ route('manager.stock-movements.index') }}"
            ...
            <tbody>
                @forelse ($movements as $movement)
                    <tr class="border-b hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3">
                            <x-badge :variant="$movement->type === 'in' ? 'success' : ($movement->type === 'out' ? 'danger' : 'warning')">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-4 py-8 text-center text-gray-400">No Stock Movement Found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
